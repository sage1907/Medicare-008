        ...
        <div className="mb-5">
          ...
          {formData.experiences?.map((item, index) => (
            <div>
              ...
              <button onClick={e => deleteExperience(e, index)} className="bg-primaryColor p-2 rounded-full text-white text-[18px] mt-2 mb-[30px] cursor-pointer">
                <AiOutlineDelete />
              </button>
            </div>
          ))}
              ...
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  ...
                  <div className="flex items-center ">
                    <button onClick={e => deleteTimeSlot(e, index)} className="bg-primaryColor p-2 rounded-full text-white text-[18px] mt-2 mt-6 cursor-pointer">
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
